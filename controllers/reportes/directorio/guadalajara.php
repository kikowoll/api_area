...
$stm = $con->prepare("SELECT * FROM area7 WHERE ciudad = :sitio  ORDER BY zona ASC");
$stm->bindvalue(':sitio', 'GUADALAJARA');
$stm->execute();
...
<table>
    <tbody>
        <tr class="saltoPagina">
            <td colspan="10"><img src="<?= $base64 ?>" alt="cabeza"></td>
        </tr>
    </tbody>
<?php
        ...
        <tbody>
            <?php
                ...
                if($i == 0) {
                    echo '
                    <tr>
                        <td colspan="10" style="background-color: #333; color: #eee; font-size:14px;text-align:center;">GUADALAJARA</td>
                    </tr>';
                } else {
                    echo '
