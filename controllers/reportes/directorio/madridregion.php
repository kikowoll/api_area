...
$stm = $con->prepare("SELECT * FROM area7 WHERE sitio != :sitio AND ciudad = :sitio  ORDER BY zona ASC");
        ...
        <tbody>
            <?php
                ...
                if($i == 0) {
                    echo '
                    <tr>
                        <td colspan="10" style="background-color: #333; color: #eee; font-size:14px;text-align:center;">MADRID REGION</td>
                    </tr>';
                } else {
                    echo '
